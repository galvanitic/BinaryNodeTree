...
#ifndef BINARYTREES_BINARYNODETREE_H
#define BINARYTREES_BINARYNODETREE_H
...
//    -------------------------------------------------
    ...
    void graphorder(std::ostream &out, int indent, std::shared_ptr<BinaryNode<ItemType>> treePtr) const;
public:
//    -------------------------------
...
//    ---------------------------------------------
    ...
    void graphdisplay(std::ostream &out) const;
...
#endif //BINARYTREES_BINARYNODETREE_H
